...
public class Java125_RegEx {
	...
	public static void main(String[] args) {	
		...
		//st변수에 저장된 값이 a이나 b로 시작하고 임의문자가 5개이면 true 아니면 false을 리턴한다.
		System.out.println(st.matches("[ab].{5}"));
		
		//st변수에 저장된 값이 a이나 b로 시작하고 임의문자가 1개에서 5개이며 cc로 끝나면 
		//true 아니면 false을 리턴한다.
		...
		System.out.println(mc.find(0)); //0을 검색위치 인덱스
		...
		input1 = "abce3dgs";
		System.out.print(input1.matches("[a-zA-Z0-9]{5,10}") 
