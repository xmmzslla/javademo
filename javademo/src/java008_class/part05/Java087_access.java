/*
 * package 패키지명;(소문자로만 씀) package java.lang;
 ...
 *  package : kr.gov
 *  
 *  import : 외부 클래스 및 인터페이스 위치를 JVM에 알려주기 위해서 사용된다.
 *  
 *  제어자(modifier)
 *  1. 클래스, 변수, 메소드, 생성자의 선언부에 사용되어 부가적인 의미를 부여한다.
 *  2. 제어자는 크게 접근제어자(access modifier)와 그 외의 제어자로 구분한다.
 *  3. 하나의 대상에 여러개의 제어자를 조합해서 사용할 수 있으나. 절대 접근자는 단 하나만 사용할 수 있다.
 *     접근제어자 - public, protected, abstract, synchronized...
 ...
 * 3. protected : 같은 패키지 내에서, 그리고 다른 패키지의 자속 클래스에서 접근이 가능하다.
 * 4. public : 접근 제한이 없다.
 * 
 * 접근자 사용
